...
<div class="page-content p-5" id="content">
  ...
  <div class="row">
    <div class="col-lg-12 mr-2">
      <a href="input_rumah.php" class="btn btn-info">Tambah</a>
    </div>
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          <table class="table">
            ...
            <tbody>
              <?php
                            include 'koneksi.php';
                            $query = $conn->query("SELECT * FROM rumah");
                            $no = 0;
                            if ($query->num_rows > 0) {
              ...
              <tr>
                ...
                <td><?= $row[4]; ?></td>
                <td>
                  <a href="edit_rumah.php?id=<?= $row[0]; ?>" class="btn btn-info"><i
                      class="fa fa-pencil-square-o"></i></a>
                  <a href="delete_rumah.php?id=<?= $row[0]; ?>" class="btn btn-danger btn-hapus-rumah"><i
...
$('.btn-hapus-rumah').on('click', function(e) {
  e.preventDefault();
